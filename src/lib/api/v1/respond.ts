...
export type ApiErrorCode =
  ...
  | 'account_suspended' // valid key, but its account is suspended (billing)
...
/** 403 — the key is valid, but the account it belongs to is suspended. */
export function accountSuspended(message = 'This account is suspended'): ApiError {
